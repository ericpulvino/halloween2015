...
resp = conn.sendSOAP('192.168.1.10:49153', 'urn:Belkin:service:basicevent:1', 
     'http://192.168.1.10:49153/upnp/control/basicevent1', 
...
LOGGER.write( str(current_time) + " - Back Porch turned off." + "\n")
LOGGER.close()
