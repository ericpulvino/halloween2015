...
resp = conn.sendSOAP('192.168.1.6:49153', 'urn:Belkin:service:basicevent:1', 
     'http://192.168.1.6:49153/upnp/control/basicevent1', 
...
LOGGER.write( str(current_time) + " - Driveway Light turned off." + "\n")
LOGGER.close()
