...
resp = conn.sendSOAP('192.168.1.7:49153', 'urn:Belkin:service:basicevent:1', 
     'http://192.168.1.7:49153/upnp/control/basicevent1', 
...
LOGGER.write( str(current_time) + " - Kitchen Sink Light turned off." + "\n")
LOGGER.close()
